...
impl App {
    const XODIUM_REPOSITORY_URL: &str = "https://github.com/XodiumSoftware";
    const XCAD_REPOSITORY_URL: &str = "https://github.com/XodiumSoftware/xcad";
    const XCLOUD_REPOSITORY_URL: &str = "https://github.com/XodiumSoftware/xcloud";
    const EGUI_REPOSITORY_URL: &str = "https://github.com/emilk/egui";
    const EFRAME_REPOSITORY_URL: &str = "https://github.com/emilk/egui/tree/master/crates/eframe";
    const CONTACT_EMAIL_URL: &str = "mailto:info@xodium.org";
    const LICENSE_URL: &str = "https://www.gnu.org/licenses/agpl-3.0.html";
                            ...
                            ui.menu_button("Projects", |ui| {
                                ui.vertical(|ui| {
                                    Utils.project_card(
                                        ui,
                                        "xCAD",
                                        "CAD Software providing automative tools written in Rust",
                                        Self::XCAD_REPOSITORY_URL,
                                    );
                                    ui.add_space(5.0);
                                    Utils.project_card(
                                        ui,
                                        "xCloud",
                                        "Cloud Backend Service for xCAD",
                                        Self::XCLOUD_REPOSITORY_URL,
                                    );
                                });
                            });
                        }
